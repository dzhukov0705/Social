//
//  ChangeRestaurantViewController.h
//  SocialDining
//
...
@interface ChangeRestaurantViewController : ViewController <MKMapViewDelegate, CLLocationManagerDelegate>
{
